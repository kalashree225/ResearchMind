      ...
      >
        ...
        <div className="glass-panel rounded-3xl p-8 border border-border/50 shadow-2xl">
          ...
          <div className="space-y-3 opacity-50 pointer-events-none">
            <button
              className="w-full py-3 px-4 bg-white text-gray-800 rounded-xl font-semibold shadow-lg border border-gray-200 flex items-center justify-center gap-3"
            >
              <FcGoogle size={20} />
              Google
            </button>
            ...
            <button
              className="w-full py-3 px-4 bg-gray-900 text-white rounded-xl font-semibold shadow-lg flex items-center justify-center gap-3"
            >
              <FaGithub size={20} />
              GitHub
            </button>
